"""Общие настройки для всего проекта тестирования.

Корневой conftest: содержит фикстуры, не требующие Django (BytesIO, ZIP-тесты),
а также регистрирует ``tests.fixtures`` для всех поддиректорий.
"""
